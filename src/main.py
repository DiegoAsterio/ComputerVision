...
if __name__=="__main__":
    ...
    # parameters = [(1,0,3), (1,0,5), (0,1,3), (2,0,3), (2,0,5), (1,1,3), (1,1,5), (2,1,3), (2,1,5), (2,2,3), (2,2,5) ]
    ...
    # imLG1B1 = core.calculateConvolutionLDG(im1, 5, 1, cv.BORDER_REPLICATE)
    # core.pintaI(imLG1B1)
    
    # # L-G with sigma = 1 border fedcba|abcdefgh|hgfedcb
    # imLG1B2 = core.calculateConvolutionLDG(im1, 5, 1, cv.BORDER_REFLECT)
    # core.pintaI(imLG1B2)

    # # L-G with sigma = 3 border aaaaaa|abcdefgh|hhhhhhh
    # imLG3B1 = core.calculateConvolutionLDG(im1, 7, 3, cv.BORDER_REPLICATE)
    # core.pintaI(imLG3B1)

    # # L-G with sigma = 3 border fedcba|abcdefgh|hgfedcb
    # imLG3B2 = core.calculateConvolutionLDG(im1, 7, 3, cv.BORDER_REFLECT)
    # core.pintaI(imLG3B2)
    ...
    for sigma,vector in vectoresMascaraGaussianos:
        print("sigma = {:d}, tam = {:d}, mascara1D = [{:s}, ...]\n".format(sigma,len(vector[0:2]),", ".join(map(str,vector[0:2]))))
    ...
    a,b,hybridIm1 = core.getHybridIm(11,5,im3,7,5,im4) 
    
    core.showMyOwnGPyr(hybridIm1)

    a,b,hybridIm2 = core.getHybridIm(15,10,im5,35,33,im6)

    core.showMyOwnGPyr(hybridIm2)

    a,b,hybridIm3 = core.getHybridIm(11,9,im7,7,5,im8)

    core.showMyOwnGPyr(hybridIm3)

    a,b,hybridIm4 = core.getHybridIm(5,3,im9,5,3,im10)

    core.showMyOwnGPyr(hybridIm4)

    a,b,hybridIm5 = core.getHybridIm(9,6,im12,13,8,im11)
